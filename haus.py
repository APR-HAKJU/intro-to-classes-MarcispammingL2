...
class Haus:
    def __init__(self, quadratmeter, schlafzimmer, badezimmer): #wird aufgerufen wenn ein neues Objekt erteillt wird
        # z.B.: Haus()
...
haus2= Haus(quadratmeter=85, schlafzimmer=2, badezimmer=1)
...
haus4 = Haus(quadratmeter=200, schlafzimmer=3, badezimmer=4)
